...
public class QnAController {
    ...
    public ResponseEntity<List<CommonDto<QnAResponseDto>>> getAllQnA(@PathVariable Long apartId) {


        List<CommonDto<QnAResponseDto>> responseDto = qnAService.selectAll(apartId);
